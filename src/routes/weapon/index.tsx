...
import SeachWeapons from './_components/SeachWeapons'
import WeaponCard from './_components/WeaponCard'
import WeaponDetailnfo from './_components/WeaponDetailnfo'
import WeaponSkeleton from './_components/WeaponSkeleton'
